    ...
    return (
        <div className="container">
            ...
            <div className="container__image">
                <img className="hero-image" src={headerCard} alt="manage Your Nannu Share" />
            </div>
        </div>
    )
}
...
export default function Hero() {
    return (
        <div className="Hero">
            ...
            <Experiment trackedAction="text change"
                id="842d507a-dc2e-4985-88f1-e944aa73720e">
                <Variant>
                    {(callback) => <MyHeroExperience onAction={callback} title="Easily create or join a local nanny share with Hapu;" 
                ...
                <Variant>
                    {(callback) => <MyHeroExperience onAction={callback} title=" Create the childcare you need at a price you can afford"
